...
namespace Brasserie.ViewModel
{
    ...
    {
        public StaffMembersPageViewModel(IAlertService alertService, IDataAccess dataAccessService) : base(alertService)
        {
        ...
        /// <summary>
        /// Save changes, add, delete staffMembers datas to the source.
        /// </summary>
        [RelayCommand()]
        ...
        public void ShowNewStaffMemberPopup()
        {
            ...
            StaffMemberPopupDisplayed = new StaffMember(nextId, "Nom", "Prenom", true, "youremail@gmail.com", "0470000000", "BE00 0000 0000 0000", "1, rue 1000", 0.0);

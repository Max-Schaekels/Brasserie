...
namespace Brasserie.Model.Restaurant
{
    public class MainInformations : INotifyPropertyChanged
    {
        ...
        /// <summary> /// Restaurant's name /// </summary> 
        public string Name
        {
            get => _name;
            set
        ...
        /// <summary> /// Vat balgian company code /// </summary>
        ...
        public static bool CheckBelgianVatCode(string tryCode)
        {
            if (!string.IsNullOrEmpty(tryCode))
            {
                ...
                {
                    //MessageBox.Show($"La saisie {trytryCode} ne correpond pas au format ", "Erreur de saisie", MessageBoxButton.OK, MessageBoxImage.
                    return false;
                }
                return true;
            }
        ...
        /// <summary> /// Check Name must be at least one char. /// </summary> /// <param name="tryAccount"></param> /// <returns></returns> 
        ...
        /// <summary> /// Vat Code number for belgian company Ex: BE 0563.191.043 /// </summary> /// <param name="tryUrl"></param> /// <returns></returns> 
        ...
        /// <summary> ///Check address format typical "23, rue de la bénédiction 7000 Mons"
        ///"[N°](A,B,...), [nom de rue] [code postal] [Ville (Pays)]"
        /// </summary> /// <param name="tryAddress"></param> /// <returns></returns> 
